...
template<class l, class r, typename std::enable_if<std::is_floating_point<r>{} || std::is_integral<r>{} || is_complex<r>{},
...
template<class l, class r, typename std::enable_if<std::is_floating_point<l>{} || std::is_integral<l>{} || is_complex<l>{},
...
template<class l, class r, int N, typename std::enable_if<std::is_floating_point<r>{} || std::is_integral<r>{} || is_complex<r>{},
r>::type* = nullptr> strong_inline typename
std::enable_if<std::is_constructible<typename iScalar<l>::scalar_type,
...
template<class l, class r, int N, typename std::enable_if<std::is_floating_point<l>{} || std::is_integral<l>{} || is_complex<l>{},
l>::type* = nullptr> strong_inline typename
std::enable_if<std::is_constructible<typename iScalar<r>::scalar_type,
