...
#pragma message("include sve_multcomplex_real_ref.h")
  ...
  struct MultComplex{
    ...
    inline vec<T> operator()(const vec<T> &a, const vec<T> &b){
      ...
      vec<T> out;
      typename acle<T>::vt r0_v, r1_v, r2_v, r3_v, r4_v, r5_v;
      ...
      *r_v = svmla_x(pg1, r5_v, r0_v, *a_v);     //  ar*br-ai*bi ai*br+ar*bi ...
